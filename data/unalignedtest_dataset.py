...
class UnalignedTestDataset(BaseDataset):
    ...
    def initialize(self, opt):
        ...
        self.mr_max = opt.mr_max    #same value as training
        self.mr_min = opt.mr_min    #same value as training
        self.ct_max =  opt.ct_max      #same value as training
        self.ct_min = opt.ct_min       #same value as training
