...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--mr_max', type=float, default=1769.8, help='input batch size')    #####
        parser.add_argument('--mr_min', type=float, default=-129.32, help='input batch size')    #####
        parser.add_argument('--ct_max', type=float, default=4218.1, help='input batch size')    #####
        parser.add_argument('--ct_min', type=float, default=-102.75, help='input batch size')    #####
        ...
        parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [unaligned | aligned | single | unalignedtrain | unalignedtest]')
